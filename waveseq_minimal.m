function waveseq_minimal( big_h5_file, level, threshmethod, hdf_datafield, output_file_string, slice_toggle, start_string, end_string,scaling_string, p_value_string, chr_string,bpoint_only_string )

%function waveseq_hdf5_complete( big_h5_file, level, threshmethod, hdf_datafield, output_file_string, slice_toggle, start_string, end_string, scaling_string, p_value_string, chr_string, bpoint_only_string )
...
fprintf( fid, '%lu\t %lu\t %lu\t %lu\t %lu\t %.4f\t %.4f\t %lu\t %.4f\n', datacluster3' );
fclose(fid);
